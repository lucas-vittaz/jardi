    ...
    <div class="container">
      <div class="row mb-3">
        ...
        <div class="col-sm-12 col-md-5">
          <h3 class="card-title"><span class="bold-title">01</span> Entretien d'espaces verts</h3>
          <div class="card">
      ...
      <div class="row">
        ...
        <div class="col-sm-12 col-md-5 m-auto mb-5">
          <h3 class="card-title"><span class="bold-title">03</span> Création paysagère</h3>
          <div class="card">
            <div class="card-body m-auto">
              <ul>
        ...
        <div class="col-sm-12 col-md-4 mb-5">
          <div class="my-card p-3">
            ...
            <div class="row">
              <div class="col mt-2">
                  <p>
                  Nous avons confié  des travaux d’élagage dans notre propriété à l’entreprise Jardi'CA.<br>
        ...
        <div class="col-sm-12 col-md-4 mb-5">
          <div class="my-card p-3">
            ...
            <div class="row">
              <div class="col mt-2">
                  <p>
                    Tres bonne expérience ! Nous avons sollicité Jardi'CA pour la taille de nos haies. Le travail est soigné, le ramassage aussi. Aucun dégât sur nos autres arbres et arbustes ou dans le potager. Génial ! Nous recommandons sans hésitation !</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row">
                  ...
                  <div class="col mb-3">
                    <select class="form-select" name="type" aria-label="Default select example" required>
                      <option value="Non renseigné" selected>Type de demande</option>
      ...
      <div class="row flex-column flex-nowrap flex-sm-row flex-sm-wrap">
        ...
        <div class="col mb-3">
          ...
          <ul class="nav flex-column">
            ...
            <li class="nav-item mb-2">
              <a href="#prestations" class="nav-link p-0 "
                >Nos prestations</a
              >
            </li>
            <li class="nav-item mb-2">
        ...
        <div class="col mb-3">
          ...
          <ul class="nav flex-column">
            <li class="nav-item mb-2">
              <p><a href="https://www.facebook.com/JardinierChapellesurerdre" target="_blank" class="nav-link p-0"
                ><i class="fa-brands fa-facebook-square"></i
              > Facebook</a></p>
            </li>
            <li class="nav-item mb-2">
              <p><a href="https://www.google.com/maps/place/Jardi'CA/@47.3032138,-1.5463036,15z/data=!4m5!3m4!1s0x0:0x1eaa6899f9bc8382!8m2!3d47.3032138!4d-1.5463036" target="_blank" class="nav-link p-0">
                <i class="fa-brands fa-google"></i>
               Google Buisness</a></p>
            </li>
            <li class="nav-item mb-2">
              <p><a href="http://jardica.net" target="_blank" class="nav-link p-0">
